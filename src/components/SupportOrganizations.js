...
import { Building, Edit, PlusCircle, MessageSquare } from 'lucide-react';
...
const InfoCard = ({ title, description, icon: Icon, delay = 0 }) => {
  return (
    <motion.div
      className="bg-white/80 backdrop-blur-sm rounded-lg p-6 shadow-md border border-gray-200"
            ...
            <div className="max-w-3xl mx-auto">
              ...
              >
                <div className="flex items-center mb-6">
                  <div className="rounded-full bg-[#2F5EA8]/10 p-3 mr-4">
                    <Building size={32} className="text-[#2F5EA8]" />
                  </div>
                ...
                {isSubmitted ? (
                  <div className="text-center p-6 bg-green-50 rounded-lg">
                    <h3 className="text-xl font-bold text-green-800 mb-2">Vielen Dank für Ihre Anfrage!</h3>
                    <p className="text-green-700">Wir werden uns in Kürze bei Ihnen melden, um die Details zu besprechen.</p>
                  </div>
                ) : (
